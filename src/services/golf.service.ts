...
export class GolfService {
  ...
  private allReviews = signal<CourseReview[]>([
    { id: 'r1', courseId: '3', author: 'John Doe', authorAvatar: 'https://media.defense.gov/2020/Feb/19/2002251686/1088/820/0/200219-A-QY194-002.JPG', rating: 5, comment: 'Absolutely stunning course. A true test of golf. Can\'t wait to play it again!', timestamp: '2 days ago' },
